...
Usage:
  plot-blocks-linear.R <block_csv> [--focal_block=<bl>] [--output_pdf=<pdf>] [--width=<w>] [--height=<h>] [--strains=<s>]

Options:
  -h --help     Show this screen.
  --version     Show version.
  --focal_block=<bl>  Name of focal block. [default: none].
