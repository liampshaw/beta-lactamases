...
Potential bug: - but potential bug - see SHV-134. Should be zero hits for ncbi_plasmid - and yet there are many. Something wrong with ordering of prevalence info? Seem to be more hits for KPC-2 than I can find myself by downloading from CARD hits.
...
# SNP distances  
snp-dists -m all_u5k_d5k_focal_gene.aln   > pangraph_all_u5k_d5k.gfa.gene.snps.tsv   
...
# Plot the distances  
Rscript "$scriptDir"/plot-output-dists.R pangraph_all_u5k_d5k.gfa.output_dists.csv plot-output.pdf
```
