...
# See 
# https://neherlab.github.io/pangraph/tutorials/tutorial_2/
# For a tutorial on reading the json output

# Saying we read the pangraph in
# KPC EXAMPLE
#pangraph_dir = "/Users/Liam/Dropbox/_Projects/pangraph/beta-lactamase/scripts/test-kpc/"
#json_file = pangraph_dir+"pangraph_kpc_u10k_d5k.json"
#kpc_pangraph = put.Pangraph.load_json(json_file)
#loc = put.Locator(kpc_pangraph)
#kpc_pangraph_map = put.pangraph_locator.build_map(kpc_pangraph.paths, kpc_pangraph.blocks)
...
# Read in a block
def readBlockAln(gene_cluster_id):
    return SeqIO.to_dict(SeqIO.parse(pangraph_dir+"test/vis/geneCluster/"+gene_cluster_id+"_na_aln.fa",\
                                    format="fasta"))
...
# Others
GENE = "CTX-M-15"
# Block with the gene in (from a blast search)
focal_block = 'OLNBEGPCML' #CTX-M-15
#focal_block = 'TKMZECHOSJ' #ndm

pangraph_dir = "/Users/Liam/Dropbox/_Projects/pangraph/beta-lactamase/scripts/"+GENE+"/"
json_file = pangraph_dir+"pangraph_all_u5k_d5k.json"
...
# We have panX output
#panX_gene_cluster_file = pangraph_dir+"test/vis/geneCluster.json" CTX-M
panX_gene_cluster_file = pangraph_dir+"test/vis/geneCluster.json"
...
# Read in all blocks
aln_dict = {block: readBlockAln(block_names[block]) for block in block_names.keys()}
